...
// Function to add a delay to the program speeed of movement of s
...
void move()
{
    ...
    delay(200);  // Add a delay to slow down the movement of the snake
...
//updating based on input values
